                ...
                <td className="px-4 py-3">
                  <div className="flex items-center gap-3">
                    ...
                    <span className={`font-semibold ${
                      isFavoriteTeam(row.team.id) ? 'text-yellow-300' : 'text-white'
                    }`}>
                      <span className="hidden max-[680px]:inline">{row.team.tla}</span>
                      <span className="inline max-[680px]:hidden">{row.team.name}</span>
                    </span>
                  </div>
                </td>
